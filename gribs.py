...
#with open('temp.csv', 'r') as f_in, open('why.csv', 'w') as f_out:
...
# read data from GRIB file
    ...
    filename = "adaptor.mars.internal-1701355005.7040007-998-9-5ef24480-49f7-494c-ada5-b388383ce8a9.grib"
...
# define view
view = mv.geoview(area_mode="name", area_name="global", coastlines=coast)
